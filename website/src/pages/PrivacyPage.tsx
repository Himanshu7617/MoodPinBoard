        ...
        <div className="container">
          ...
          >
            ...
            <ul>
              ...
              <li>
                <p>
                  <strong>Application</strong> refers to moodboard, the software
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to moodboard.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to moodboard, accessible from{" "}
                  <a
                    href="https://mood-board-kvjcefq30-himanshus-projects-2d0b477c.vercel.app/"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    https://mood-board-kvjcefq30-himanshus-projects-2d0b477c.vercel.app/
                  </a>
                </p>
              </li>
              <li>
